...
export const participantNormalCardStyles = ({ collapsed, isActive, maxWidth, isBeingEdited }) => ({
  ...
  contentWrapper: ({ palette }) => ({
    ...
    background: isActive
      ? palette.components.participant.background.active
      : palette.components.participant.background.default,
    border: isActive ? `0.0625rem solid ${palette.border.lines}` : undefined,
    ':hover': {
