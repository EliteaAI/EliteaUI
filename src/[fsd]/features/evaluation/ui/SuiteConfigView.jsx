...
import ResultsScorecardDialog from './ResultsScorecardDialog';
  ...
  return (
    ...
    >
            ...
            <Box sx={styles.selectorRow}>
              ...
              {canCreateSuite && (
                <Button.BaseBtn
                  ...
                  onClick={() => setNewSuiteDialog({ open: true, name: '' })}
      ...
      <Modal.BaseModal
        ...
        title="New suite"
        onClose={() => setNewSuiteDialog({ open: false, name: '' })}
        content={
          <Box sx={styles.newSuiteContent}>
            <TextField
              ...
              onChange={event => setNewSuiteDialog(prev => ({ ...prev, name: event.target.value }))}
        ...
        actions={
          <>
            <Button.BaseBtn
              variant={BUTTON_VARIANTS.elitea}
              color={BUTTON_COLORS.secondary}
              onClick={() => setNewSuiteDialog({ open: false, name: '' })}
            >
              Cancel
            </Button.BaseBtn>
            <Button.BaseBtn
      ...
      <BindingDetailDialog
        ...
        dimensions={dimensions}
        codeValidations={codeValidations}
        onClose={() => setBindingDialog({ open: false, binding: null })}
      />
      ...
      <LibraryPickerDialog
        ...
        onClose={() => setPickerDialog({ open: false, kind: null })}
      />
      ...
      <DimensionEditorDialog
        ...
        onClose={() => setDimensionDialog(false)}
      />
      ...
      <CodeValidationEditorDialog
        ...
        onClose={() => setCodeValidationDialog(false)}
      />
