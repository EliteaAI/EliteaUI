...
const ImageGenerationModelSelect = memo(props => {
  const {
  ...
  const selectedOption = useMemo(() => {
    return modelsMenuData.find(option => option.name === value);
  }, [modelsMenuData, value]);
...
ImageGenerationModelSelect.displayName = 'ImageGenerationModelSelect';
...
export default ImageGenerationModelSelect;
