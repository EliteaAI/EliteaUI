...
const emptyListPlaceHolder = (
  <Box>
    You have not liked any pipelines yet. <br />
    Choose the pipelines you like now!
  </Box>
);
const emptySearchedListPlaceHolder = (
  <Box>
    No pipelines found yet. <br />
    Publish yours now!
  </Box>
);
...
export default function MyLiked() {
  ...
  return (
    <CardList
      ...
      loadMoreFunc={loadMorePipelines}
      cardType={ContentType.PipelineMyLiked}
