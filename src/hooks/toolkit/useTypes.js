...
/**
 * Custom hook for managing toolkit type filtering
 * Similar to useTags but specifically designed for toolkit types
 */
const useTypes = () => {
  ...
  const handleClickType = React.useCallback(
    (e, type) => {
      // Support both direct click (e.target.innerText) and tag object parameter for compatibility with Categories component
